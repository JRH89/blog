...
import { DribbbleIcon, GithubIcon, LinkedinIcon, MoonIcon, SunIcon, TwitterIcon, YouTubeIcon } from "../Icons"
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
      ...
      <div className=" hidden sm:flex items-center">
        ...
        <a href={siteMetadata.youtube} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4 align-middle" aria-label="Watch my channel on Youtube" target="_blank"><i className="fa-brands fa-youtube hover:scale-125 transition-all ease duration-200 text-red-600 align-middle text-2xl"></i></a>
      </div>
    </header>
  )
}
